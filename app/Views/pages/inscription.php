            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                    ...
                    <form action="<?= base_url() . '/inscription/a' ?>" method='POST' enctype='multipart/form-data'>
                        ...
                        <button type="submit" class="btn btn-info  w-100 mb-4">inscription</button>
                    </form>
                    <p class="text-center mb-0">Avez vous deja un compte? <br> <a href="<?= base_url('connexion') ?>">Connexion</a></p>
                </div>
            </div>
        </div>
    </div>
