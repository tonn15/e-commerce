		...
		<?php if (isset($_SESSION['user'])) : ?>
			<div class="dropdown nav-item bg-dark" style="height: 34px;">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="<?= base_url('deconnexion') ?>"><i class="fa-sharp fa-solid fa-right-to-bracket"></i><span class="doctor"> deconnexion</span></a>
					<?php if (isset($_SESSION['user']) && $_SESSION['user']['role'] == 'dj;fisjdkflhkjhdufhskdjhfjsdfuhjhsdkfhuihiuhdf') : ?>
						<a class="dropdown-item" href="<?= base_url('steev-admin') ?>"><i class="fa-sharp fa-solid fa-cross"></i><span class="doctor"> administrateur</span></a>
					<?php endif ?>
				</div>
			</div>
		<?php else : ?>
